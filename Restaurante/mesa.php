        ...
        <tbody>
            <?php foreach ($reservas as $mesa): ?>
                <tr>
                    ...
                    <td>
                        <a href="editar_mesa.php?id=<?= $mesa['id'] ?>" class="btn btn-warning btn-sm">Editar</a>
                        <a href="pedido.php?mesa_id=<?= $mesa['id'] ?>" class="btn btn-primary btn-sm">Adicionar Produtos</a>
